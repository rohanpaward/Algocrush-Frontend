    ...
    <div className="min-h-screen bg-[#050505] text-slate-200 pb-40">
      ...
      <nav className="fixed top-0 inset-x-0 h-20 bg-[#050505]/80 backdrop-blur-xl border-b border-white/[0.05] z-50">
        <div className="max-w-2xl mx-auto h-full flex items-center justify-between px-8">
          ...
          <button 
            onClick={handleSave}
            className="bg-white text-black px-6 py-2.5 rounded-full text-[10px] font-black uppercase tracking-widest flex items-center gap-2 hover:scale-105 active:scale-95 transition-all shadow-[0_0_20px_rgba(255,255,255,0.1)]"
          >
            Save <span className="hidden sm:inline">Changes</span> <Check size={14} strokeWidth={3} />
          </button>
